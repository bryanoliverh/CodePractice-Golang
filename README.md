...
37. [findPeakElement.go](https://github.com/bryanoliverh/CodePractice-Golang/blob/main/findPeakElement.go)
 ...
 38. [plusOne.go](https://github.com/bryanoliverh/CodePractice-Golang/blob/main/plusOne.go)

  - You are given a large integer represented as an integer array digits, where each digits[i] is the ith digit of the integer. The digits are ordered from most significant to least significant in left-to-right order. The large integer does not contain any leading 0's. Increment the large integer by one and return the resulting array of digits.

  - digits... is a variadic parameter that allows a function to accept a variable number of arguments of the same type as the parameter. When digits... is used as a function argument, it expands the elements of the digits slice and passes them as separate arguments to the function. This allows us to pass multiple values of the same type as individual arguments to the function.
